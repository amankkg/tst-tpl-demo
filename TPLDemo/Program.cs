    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            while (tasks.Count > 0)
            {
                ...
                else if (finished == eggsTask) Console.WriteLine("eggs are ready");
                else if (finished == baconTask) Console.WriteLine("bacon is ready");
            }
        ...
        static async Task<Toast> MakeToastWithButterAndJamAsync(int slices)
        {
